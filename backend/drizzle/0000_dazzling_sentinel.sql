...
ALTER TABLE "payments" ADD CONSTRAINT "payments_order_id_order_tickets_uuid_fk" FOREIGN KEY ("order_id") REFERENCES "public"."order_tickets"("uuid") ON DELETE cascade ON UPDATE no action;