  ...
  const services = [
    {
      ...
      features: ["Door-to-door service", "Real-time tracking", "Insurance included", "24/7 customer support"],
    ...
    },
    {
      ...
      features: ["Warehouse management", "Inventory control", "Distribution network", "Custom clearance"],
    ...
    },
    {
      ...
      features: ["Heavy cargo", "Temperature controlled", "Fragile items", "Oversized goods"],
      deliveryTime: "Custom"
    }
  ];

  const coverageAreas = [
    { region: "Jawa", cities: ["Jakarta", "Bandung", "Semarang", "Surabaya", "Yogyakarta"] },
    { region: "Sumatera", cities: ["Medan", "Palembang", "Padang", "Pekanbaru"] },
    { region: "Bali & Nusa Tenggara", cities: ["Denpasar", "Mataram", "Kupang"] },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
              Layanan pengiriman barang yang handal, aman, dan terpercaya ke seluruh Indonesia
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Berbagai solusi logistik untuk memenuhi kebutuhan pengiriman barang Anda
            </p>
          </div>
